        ...
        return {
            ...
            link : function (scope, el, attrs, ctrl) {
                ctrl.$parsers.unshift(function (viewValue) {
                    ...
                    var l = IQ.isEmpty(viewValue) ? 0 : viewValue.length;
                    if (l == 0) {
            ...
            return {
                ...
                link : function (scope, el, attr) {
                    $('body').on('keydown.hotkey', function ($event) {
                        ...
                        var HotKeys = KO.TypeDef.HotKeys;
                        IQ.Debug.info("path is " + path);
                        IQ.Debug.info("search is ");
                        IQ.Debug.info(search);
                        IQ.Debug.info("keyCode is " + $event.keyCode);
                        IQ.Debug.info("charCode is " + $event.charCode);
                        IQ.Debug.info("which is " + $event.which);
                        ...
                        switch(moudleName) {
                            case "snack":
                            case "dinner":
                                IQ.Debug.info("dinner|snack moudle");
