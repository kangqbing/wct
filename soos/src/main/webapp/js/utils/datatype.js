...
(function () {
	...
	KO.TypeDef.CommonErrorMsgs = {
		"connect_faild" : "通信失败，请稍后再试"
	};

	// 与硬件交互通用指令集
	// 需要向剪切板中写入特定标签的数据
	KO.TypeDef.DeviceComCmds = {
		// 打印账单消费明细
	 ...
	 * @type {Array}
	 */
	KO.TypeDef.OrderPaySubjectGroups = [
		...
		{name : "kooPay", value : "11311000", isPrefix : "0", label : "哗啦啦"},
	 ...
	 * @type {Array}
	 */
	KO.TypeDef.ShopServiceFeatures = [
	...
	KO.TypeDef.CompBizQueryRangeLst = [
		{value : 'ZH', label : '综合'},
		// 新增报表项目
